...
function conversacion() {
  ...
  for (var i = 0; i < arrayConversacion.length; i += 2) {
    ...
    botonCopiarCelda.appendChild(document.createTextNode("Copiar"));
  ...
  function copiarTextoAlPortapapeles(textoCopiar) {
    // Copiar el contenido del elemento a un portapapeles (puedes personalizar esta lógica según tus necesidades)
